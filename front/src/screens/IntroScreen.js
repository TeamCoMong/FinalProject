    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity style={styles.loginButton} onPress={() => navigation.navigate('TestLoginScreen')}>
                    <Image source={require('../assets/blindness.png')} style={styles.buttonIcon} />
                    <Text style={styles.buttonText}>사용자 모드</Text>
                </TouchableOpacity>

                <TouchableOpacity style={styles.signUpButton} onPress={() => navigation.navigate('TestLoginScreen')}>
