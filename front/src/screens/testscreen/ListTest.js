...
const ListTest = () => {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.title}>📋 관리자 목록 조회</Text>

            <TouchableOpacity
                style={styles.button}
                onPress={() => setShowUsers(prev => !prev)}>
                <Text style={styles.buttonText}>{showUsers ? '🔽 사용자 리스트 닫기' : '▶ 사용자 리스트 보기'}</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
                ...
                <Text style={styles.buttonText}>{showGuardians ? '🔽 보호자 리스트 닫기' : '▶ 보호자 리스트 보기'}</Text>
            </TouchableOpacity>
